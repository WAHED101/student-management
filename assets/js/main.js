...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.flatpickr(dobInput, {
      ...
      onReady: (selectedDates, dateStr, instance) => {
        ...
        if (alt) {
          ...
          originalClasses
            .split(/\s+/)
            .forEach((c) => c && alt.classList.add(c));
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const mobileBottomNavLinks = document.querySelectorAll(
      ".mobile-navbar-bottom .nav-link[data-section]"
    );
    ...
    if (mobileMoreToggle && mobileMoreDropdown && mobileMoreBackdrop) {
      ...
      mobileMoreToggle.addEventListener("click", (e) => {
        e.preventDefault();
        e.stopPropagation();
        mobileMoreDropdown.classList.contains("show")
          ? closeMenu()
          : openMenu();
      });
      ...
      document.addEventListener("click", (e) => {
        if (
          !mobileMoreDropdown.contains(e.target) &&
          !mobileMoreToggle.contains(e.target)
        ) {
          closeMenu();
        }
      });
